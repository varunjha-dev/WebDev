...
// ! =====================================================
// ! Function: getrestaurant(restaurants) 🍽️
// ! =====================================================
// ? This function dynamically creates restaurant cards 
// ? based on the given restaurant data array and appends 
// ? them to the 'root' container in the DOM.

function getrestaurant(restaurants) {
    // * Selecting the root container where the cards will be added
    const root = document.getElementById('root');

    // * Loop through each restaurant in the array
    restaurants.forEach(restaurant => {
        ...
        // * =====================================================
        // * 1️⃣ Create Image Section 🖼️
        // * =====================================================
        const image = document.createElement("img");
        image.src = `Images/${restaurant.image}.jpeg`;

        // * =====================================================
        // * 2️⃣ Create Card Content Section 📋
        // * =====================================================
        const Card_content = document.createElement('div');
        Card_content.classList.add('card-content');

        // ? ---------------------- Header ----------------------
        // * 2.1 Create Card Header (Contains Name & Rating)
        ...
        // * Append Name & Rating to Card Header
        Card_header.appendChild(h3);
        Card_header.appendChild(rate);

        // ? ---------------------- Footer ----------------------
        // * 2.2 Create Card Footer (Contains Food Type & Price)
        ...
        // * Append Food Type & Price to Card Footer
        Card_footer.appendChild(food);
        Card_footer.appendChild(price);

        // ? ---------------------- Location ----------------------
        // * 2.3 Create Card Location (Contains Address & Distance)
        ...
        // * =====================================================
        // * Append Image & Card Content to the Card 🏷️
        // * =====================================================
        card.appendChild(image);
        card.appendChild(Card_content);

        // * Finally, Append the Card to the Root Container 🏠
        root.appendChild(card);
    });
}

// ! =====================================================
// ! Initial Rendering of All Restaurants 🍽️
// ! =====================================================
getrestaurant(restaurants);

// ! =====================================================
// ! Filter Functionality for Alcohol Availability 🍷
// ! =====================================================
document.getElementById("Alcohol").addEventListener('click', () => {
    // * Filter restaurants that serve alcohol
    const result = restaurants.filter((obj) => obj.alcohol);

    // * Clear the existing list and update the UI
    document.getElementById('root').replaceChildren();
    getrestaurant(result);
});

// ! =====================================================
// ! Filter Functionality for High-Rated Restaurants ⭐
// ! =====================================================
...
// ! =====================================================
// ! Show Filter Popup When Clicking Filters Button 🎛️
// ! =====================================================
...
// ! =====================================================
// ! Apply Sorting Based on Selected Filter Option 📊
// ! =====================================================
document.getElementById('applyFilter').addEventListener('click', () => {
    ...
    if (answer === "rating") {
        restaurants.sort((a, b) => b.rating - a.rating); // ? Sort by Rating (Descending)
    } 
    else if (answer === "highLow") {
        restaurants.sort((a, b) => b.price_for_two - a.price_for_two); // ? Sort by Price (High to Low)
    } 
    else if (answer === "costLowHigh") {
        restaurants.sort((a, b) => a.price_for_two - b.price_for_two); // ? Sort by Price (Low to High)
    } 
    else if (answer === "distance") {
        restaurants.sort((a, b) => a.distance_from_Customer_house - b.distance_from_Customer_house); // ? Sort by Distance (Closest First)
    }

    // * Clear existing list, hide popup & update UI
    document.getElementById('root').replaceChildren();
